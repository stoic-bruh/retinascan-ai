...
│   ├── PRESENTATION.md
│   ├── DEMO.md
│   └── BetaAlanine_SIH2026_Presentation.pptx
├── docs/
│   ├── architecture.md
│   └── deployment.md
├── assets/
...
The demo video is optional. If you have one, add its direct file link or YouTube/Google Drive link to `submission/DEMO.md` and make sure it is accessible without requesting permission.
